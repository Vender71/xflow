...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/flow/project/mlflow/"
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/flow/project/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()
 
with open('/home/flow/project/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))
